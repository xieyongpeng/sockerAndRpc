 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://server.webService.domain.xie.com/", wsdlLocation = "http://localhost:8080/vip/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://server.webService.domain.xie.com/", "SayHelloImplService");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://server.webService.domain.xie.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webService.domain.xie.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
